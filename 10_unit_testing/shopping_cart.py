class ShoppingCart:
    """
    Tracks item in customer shopping cart
    ...
    def add_item(self, item, qty):
        ...
        :param item: string name of to add
        ...
        try:
            if item not in self.database.keys():
                print(f"No item wite name {item} in inventory database.")
                return
            ...
            print("There was an general error while adding item(s) to cart")
            print(e)

    def calculate_total(self):
        """
        Calculates the total price of items added to card
